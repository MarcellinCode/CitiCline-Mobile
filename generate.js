const fs = require('fs');
try {
  const img = fs.readFileSync('c:/Users/User/Desktop/RecyCla/wave-clean-mobile/assets/cleanzone_logo.png');
  const base64Str = 'data:image/png;base64,' + img.toString('base64');
  const content = 'export const CleanZone_LOGO_BASE64 = `' + base64Str + '`;\n';
